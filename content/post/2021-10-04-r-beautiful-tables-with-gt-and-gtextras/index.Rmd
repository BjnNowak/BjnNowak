...
tags:
  ...
  - 'gt'
  - 'tidyverse'
summary: "The {gtExtras} extension adds many customization options for tables created with the {gt} extension. In this tutorial we will illustrate some possibilities of these packages on a dataset about Tour de riders."
---
...
We will start by extracting the data.
...
```
[Anatole Novak](https://en.wikipedia.org/wiki/Anatole_Novak) is my grand father. He won one Tour de France stage in his career, and helped Anquetil win several Tour de France. We will see how many in the next table!
