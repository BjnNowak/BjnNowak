...
```
## 2.3. Perform the sensitivity analysis
...
No need to create a new function here, we will use the same function we created for the sensibility analysis.
...
We see that the uncertainty in the estimate of the final yield is high. This uncertainty can be reduced by optimizing the model, as we will do in the third part of this tutorial. 
